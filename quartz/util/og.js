...
export async function getSatoriFonts(headerFont, bodyFont) {
    // Get all weights for header and body fonts
    const headerWeights = (typeof headerFont === "string"
        ? defaultHeaderWeight
 ...
 */
export async function fetchTtf(rawFontName, weight) {
...
export const defaultImage = ({ cfg, userOpts, title, description, fileData, iconBase64, }) => {
    ...
    return (_jsxs("div", { style: {
            ...
            fontFamily: bodyFont,
                    ...
                    gap: "1rem",
                    marginBottom: "0.5rem",
                }, children: [iconBase64 && (_jsx("img", { src: iconBase64, width: 56, height: 56, style: {
                            borderRadius: "50%",
                        } })), _jsx("div", { style: {
                            display: "flex",
                            fontSize: 32,
                            ...
                            fontFamily: bodyFont,
                        }, children: cfg.baseUrl })] }), _jsx("div", { style: {
                    display: "flex",
                    marginTop: "1rem",
                    marginBottom: "1.5rem",
                    ...
                    borderTop: `1px solid ${cfg.theme.colors[colorScheme].lightgray}`,
                            ...
                            color: cfg.theme.colors[colorScheme].gray,
                            fontSize: 28,
                        }, children: [date && (_jsxs("div", { style: { display: "flex", alignItems: "center" }, children: [_jsxs("svg", { style: { marginRight: "0.5rem" }, width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", children: [_jsx("rect", { x: "3", y: "4", width: "18", height: "18", rx: "2", ry: "2" }), _jsx("line", { x1: "16", y1: "2", x2: "16", y2: "6" }), _jsx("line", { x1: "8", y1: "2", x2: "8", y2: "6" }), _jsx("line", { x1: "3", y1: "10", x2: "21", y2: "10" })] }), date] })), _jsxs("div", { style: { display: "flex", alignItems: "center" }, children: [_jsxs("svg", { style: { marginRight: "0.5rem" }, width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", children: [_jsx("circle", { cx: "12", cy: "12", r: "10" }), _jsx("polyline", { points: "12 6 12 12 16 14" })] }), readingTimeText] })] }), _jsx("div", { style: {
                            display: "flex",
                            gap: "0.5rem",
                            flexWrap: "wrap",
                            justifyContent: "flex-end",
                            maxWidth: "60%",
                        }, children: tags.slice(0, 3).map((tag) => (_jsxs("div", { style: {
                                display: "flex",
                                padding: "0.5rem 1rem",
