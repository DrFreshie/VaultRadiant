...
async function setupSearch(searchElement, currentSlug, data) {
    ...
    async function displayPreview(el) {
        ...
        // scroll to longest
        const highlights = [...preview.getElementsByClassName("highlight")].sort((a, b) => b.innerHTML.length - a.innerHTML.length);
