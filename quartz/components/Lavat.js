...
const LavaLamp = ({ displayClass }) => {
    return (_jsxs("div", { class: classNames(displayClass, "lava-lamp-container"), children: [_jsx("canvas", { id: "lava-lamp" }), _jsx("script", { type: "module", dangerouslySetInnerHTML: { __html: lavaScript } })] }));
};
LavaLamp.css = style;
