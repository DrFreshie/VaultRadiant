...
import DappledLightConstructor from "./DappledLight";
...
export function renderPage(cfg, slug, componentData, components, pageResources) {
    ...
    const DappledLight = DappledLightConstructor();
    ...
    const doc = (_jsxs("html", { lang: lang, dir: direction, children: [_jsx(Head, { ...componentData }), _jsxs("body", { "data-slug": slug, children: [_jsx(DappledLight, { ...componentData }), _jsx("div", { id: "quartz-root", class: "page", children: _jsxs(Body, { ...componentData, children: [LeftComponent, _jsxs("div", { class: "center", children: [_jsxs("div", { class: "page-header", children: [_jsx(Header, { ...componentData, children: header.map((HeaderComponent) => (_jsx(HeaderComponent, { ...componentData }))) }), _jsx("div", { class: "popover-hint", children: beforeBody.map((BodyComponent) => (_jsx(BodyComponent, { ...componentData }))) })] }), _jsx(Content, { ...componentData }), _jsx("div", { class: "page-footer", children: afterBody.map((BodyComponent) => (_jsx(BodyComponent, { ...componentData }))) })] }), RightComponent, _jsx(Footer, { ...componentData })] }) })] }), pageResources.js
