\documentclass[10pt,a4paper,table]{article}
	...
	\fancypagestyle{plain}{%
		...
		\fancyhead[L]{}
		\fancyhead[C]{}
		\fancyhead[R]{\overp\color{frbgreenl}\normalsize \overp Mat C-B\\\huge\color{frbgreen}\vestb Cirklens ligning}
		\cfoot{\thepage}
	}
	\pagestyle{fancy}
	\fancyhf{}
...
\subsection{}
I hver af de følgende retvinklede trekanter skal den sidste side bestemmes ved hjælp af Pythagoras' sætning.

\begin{enumerate}
    \item I en retvinklet trekant er kateterne $a=7\,\text{cm}$ og $b=24\,\text{cm}$. Bestem hypotenusen $c$.
    \item I en retvinklet trekant er kateterne $a=9\,\text{cm}$ og $b=12\,\text{cm}$. Bestem hypotenusen $c$.
    \item I en retvinklet trekant er hypotenusen $c=25\,\text{cm}$ og den ene katete $b=24\,\text{cm}$. Bestem den anden katete $a$.
    \item I en retvinklet trekant er kateterne $a=6\,\text{cm}$ og $b=8\,\text{cm}$. Bestem hypotenusen $c$.
    \item I en retvinklet trekant er hypotenusen $c=17\,\text{cm}$ og den ene katete $a=8\,\text{cm}$. Bestem den anden katete $b$.
    \item Tegn ovenstående trekanter et vilkårligt sted i et koordinatsystem.
