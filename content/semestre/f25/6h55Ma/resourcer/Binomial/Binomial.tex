\documentclass[10pt,a4paper,table]{article}
	...
	\fancypagestyle{plain}{%
		...
		\fancyhead[L]{}
		\fancyhead[C]{}
		\fancyhead[R]{\overp\color{frbgreenl}\normalsize \overp Mat C-B\\\huge\color{frbgreen}\vestb Binomialfordeling}
		\cfoot{\thepage}
	}
	\pagestyle{fancy}
	\fancyhf{}
...
\subsection{}
I hver af nedenstående situationer antages forsøget at følge en binomialfordeling.  
Bestem forsøgets parametre $n$, $p$ og $r$.

\begin{enumerate}
    \item I en urne ligger der 10 røde og 30 blå kugler. Der trækkes en kugle 12 gange med tilbagelægning.  
    Bestem $n$, $p$ og $r$, hvis man vil finde sandsynligheden for at trække præcis 4 røde kugler.

    \item I et spil kort er der 26 sorte og 26 røde kort. Der trækkes et kort 8 gange med tilbagelægning.  
    Bestem $n$, $p$ og $r$, hvis man vil finde sandsynligheden for at trække 6 sorte kort.

    \item En terning kastes 20 gange.  
    Bestem $n$, $p$ og $r$, hvis man vil finde sandsynligheden for at få et 6-tal præcis 3 gange.

    \item En mønt kastes 15 gange.  
    Bestem $n$, $p$ og $r$, hvis man vil finde sandsynligheden for at få plat 7 gange.

    \item En basketballspiller scorer på 70\,\% af sine straffekast. Han skyder 10 gange.  
    Bestem $n$, $p$ og $r$, hvis man vil finde sandsynligheden for at han rammer 8 gange.

    \item En lampe har en sandsynlighed på 0,02 for at være defekt. En butik modtager 100 lamper.  
    Bestem $n$, $p$ og $r$, hvis man vil finde sandsynligheden for at præcis 1 lampe er defekt.

    \item En eksamensopgave består af 25 multiple-choice spørgsmål med 4 svarmuligheder hver. En elev gætter tilfældigt på alle spørgsmål.  
    Bestem $n$, $p$ og $r$, hvis man vil finde sandsynligheden for at eleven får 10 rigtige.

    \item En maskine producerer 500 enheder dagligt. Hver enhed har en sandsynlighed på 0,005 for at være fejlbehæftet.  
    Bestem $n$, $p$ og $r$, hvis man vil finde sandsynligheden for at præcis 2 enheder er fejlbehæftede.

    \item Et biologi-eksperiment har 60\,\% sandsynlighed for at lykkes hver gang. Forsøget gentages 12 gange.  
    Bestem $n$, $p$ og $r$, hvis man vil finde sandsynligheden for at 9 forsøg lykkes.

    \item Et spil vinder man med sandsynlighed 0,4 pr.\ spil. En spiller prøver 5 gange.  
    Bestem $n$, $p$ og $r$, hvis man vil finde sandsynligheden for at vinde præcis 3 spil.
\end{enumerate}
\subsection{}
Udregn sandsynlighederne i øvelse 1 ved at bruge formlen
	$$ P(X=r)=p^r\cdot (1-p)^{n-r}\cdot K(n,r)$$
