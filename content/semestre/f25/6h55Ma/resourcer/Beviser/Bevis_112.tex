...
\subsection*{Differentialkvotient for $f(x)=\sqrt{x}$}
\begin{align*}
...
&=\frac{\left(\sqrt{x+h}-\sqrt{x}\right)\cdot \left(\sqrt{x+h}+\sqrt{x}\right)}{h\cdot \left(\sqrt{x+h}+\sqrt{x}\right)}\\
...
&=\frac{h}{h\cdot \left(\sqrt{x+h}+\sqrt{x}\right)}\\
&=\frac{1}{\sqrt{x+h}+\sqrt{x}}\\
\intertext{\hspace{1em} \circnum{3} Lad $h\rightarrow 0$:}
f'(x)&=\lim_{h\rightarrow 0}\left(\frac{1}{\sqrt{x+h}+\sqrt{x}}\right)\\
