...
\subsection*{Cirklens ligning: $(x-a)^2+(y-b)^2=r^2$}
\hspace{1em} \circnum{1} Opskriv formlen for afstand mellem to punkter $A(x_1,y_1)$ og $B(x_2,y_2)$ (49):
\begin{align*}
|AB|&=\sqrt{(x_2-x_1)^2+(y_2-y_1)^2}
\intertext{\hspace{1em} \circnum{2} Indsæt radius $r$, et vilkårligt punkt på cirklen $P(x,y)$, samt centrum $C(a,b)$:}
r &= \sqrt{(x-a)^2+(y-b)^2}\\
\intertext{\hspace{1em} \circnum{3} Isolér $r^2$:}
r^2 &= (x-a)^2+(y-b)^2
\end{align*}
