...
\subsection*{Løsningsformlen for andengradsligningen $ax^2+bx+c=0$}
\begin{align*}
\intertext{\hspace{1em} \circnum{1} Opskriv ligningen:}
ax^2+bx+c&=0\\
\intertext{\hspace{1em} \circnum{2} Kvadratkompletér\footnotemark\ venstre side af lighedstegnet:}
4a\left(ax^2+bx+c=0\right)&=4a\cdot 0\\
4a\cdot ax^2+4a\cdot bx+4a\cdot c&=0\\
2^2\cdot a^2\cdot x^2+2\cdot 2\cdot a \cdot bx+4ac&=0\\
(2ax)^2+2\cdot2ax\cdot b+4ac-4ac&=0-4ac\\
(2ax)^2+2\cdot2ax\cdot b+b^2&=b^2-4ac\\
(2ax+b)^2&=b^2-4ac\\
\intertext{\hspace{1em} \circnum{4} Isolér $x$ med omvendte regneoperationer:}
2ax+b&=\pm\sqrt{b^2-4ac}\\
2ax&=-b\pm\sqrt{b^2-4ac}\\
x&=\frac{-b\pm\sqrt{b^2-4ac}}{2a}\\
\end{align*}
\footnotetext{Omskriv udtrykket så det ligner kvadrattet på en toleddet størrelse}
