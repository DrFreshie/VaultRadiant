\documentclass[10pt,a4paper,table]{article}
	...
	\fancypagestyle{plain}{%
		...
		\fancyhead[L]{}
		\fancyhead[C]{}
		\fancyhead[R]{\overp\color{frbgreenl}\normalsize \overp Mat C-B\\\huge\color{frbgreen}\vestb Sandsynlighedsregning}
		\cfoot{\thepage}
	}
	\pagestyle{fancy}
	\fancyhf{}
...
\hline
\rowcolor{gray!15}
\textbf{Farve} & \textbf{Observeret antal} & \textbf{Forventet antal (hvis jævn fordeling)}\\
\hline
Rød & 25 & 20\\
Gul & 15 & 20\\
Grøn & 20 & 20\\
...
\[
H_0: \text{Farverne er jævnt fordelt (hver farve 20\%)}.
\]
...
\begin{enumerate}[label=\alph*)]
    \item Bestem den forventede frekvens for hver farve under forudsætning af, at nulhypotesen er sand (jævn fordeling).
...
\noindent
\textbf{Bemærk:} Den teoretiske grænseværdi for $\chi^2$-fordelingen med $df = 4$ (fem farver minus én) er ca. $9{,}49$ ved 5\% signifikansniveau.
