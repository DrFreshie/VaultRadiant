...
\begin{description}
\item[Theme:] Identity
\item[Text:] Joe Goldman, “Tommy Baton” (2014) (short story)
\item[Instruction:] You must analyse and interpret “Tommy Baton” by Joe Goldman and make a presentation (roughly 8 minutes) of the text and relate it to the theme. Apart from your own points, you must include the following points in your presentation:
\begin{itemize}
\item interrelationships between characters
\item the style of writing used by Joe Goldman
\end{itemize}
\end{description}
...
\includepdf[pages=1-]{Tommy Baton.pdf}
