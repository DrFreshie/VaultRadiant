\documentclass[10pt,a4paper,table]{article}
  ...
  \usepackage{transparent}
	...
	\fancypagestyle{plain}{%
		...
		\fancyhead[L]{}
		\fancyhead[C]{}
		\fancyhead[R]{\overp\color{frbgreenl}\normalsize \overp Mat C-B\\\huge\color{frbgreen}\vestb Afstande}
		\cfoot{\thepage}
	}
	\pagestyle{fancy}
	\fancyhf{}
...
\vspace{4em}
\subsection{}
Bestem afstanden mellem 
\begin{enumerate}
  \item Punktet $P(2,3)$ og linjen $l: y=2x+1$.
  \item Punktet $P(-1,4)$ og linjen $l: y=-x+2$.
  \item Punktet $P(3,-2)$ og linjen $l: y=3x-5$.
  \item Punktet $P(0,5)$ og linjen $l: y=-2x+1$.
\end{enumerate}

\subsection{}
Bestem hypotenusen i hver af de følgende retvinklede trekanter.
\begin{enumerate}
  \item Kateterne er $a=6\,\text{cm}$ og $b=8\,\text{cm}$.
  \item Kateterne er $a=9\,\text{m}$ og $b=12\,\text{m}$.
  \item Kateterne er $a=7\,\text{cm}$ og $b=24\,\text{cm}$.
  \item Kateterne er $a=10\,\text{m}$ og $b=15\,\text{m}$.
\end{enumerate}

\subsection{}
Bestem afstanden mellem følgende punktpar.
\begin{enumerate}
  \item Punkterne $A(1,2)$ og $B(5,-1)$.
  \item Punkterne $C(-3,4)$ og $D(2,-2)$.
  \item Punkterne $E(0,-5)$ og $F(-7,1)$.
  \item Punkterne $G(-4,-3)$ og $H(6,2)$.
\end{enumerate}

\subsection{}
Bestem afstanden mellem
\begin{enumerate}
  \item Punktet $P(4,6)$ og linjen $l: y=-\frac{1}{2}x+3$.
  \item Punktet $P(-2,1)$ og linjen $l: y=4x-3$.
  \item Punktet $P(5,-4)$ og linjen $l: y=\frac{1}{3}x+2$.
  \item Punktet $P(0,-6)$ og linjen $l: y=-3x+1$.
\end{enumerate}
