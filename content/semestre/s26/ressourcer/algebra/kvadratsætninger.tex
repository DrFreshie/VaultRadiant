...
\documentclass[10pt,a4paper,table]{article}
	...
	\fancypagestyle{plain}{%
		...
		\fancyhead[L]{}
		\fancyhead[C]{}
		\fancyhead[R]{\overp\color{frbgreenl}\normalsize \overp Mat C-B\\\huge\color{frbgreen}\vestb Kvadratsætninger}
		\cfoot{\thepage}
	}
	\pagestyle{fancy}
	\fancyhf{}
...
\vspace{4em}
\subsection{}
Omskriv følgende udtryk ved hjælp af 1. kvadratsætning:
...
\subsection{}
Omskriv følgende udtryk ved hjælp af 2. kvadratsætning:
...
\subsection{}
Omskriv følgende udtryk ved hjælp af 3. kvadratsætning:
