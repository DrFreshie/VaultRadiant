...
\fancypagestyle{plain}{%
  ...
  \fancyhead[L]{}
  \fancyhead[C]{}
  \fancyhead[R]{\overp\color{frbgreenl}\normalsize \overp Mat C-B\\\huge\color{frbgreen}\vestb Funktioners monotoniforhold}
  \cfoot{\thepage}
}
\pagestyle{fancy}
\fancyhf{}
...
\begin{enumerate}[label=\arabic*)]
  ...
  \item Opstil et fortegnsskema for $f'(x)$ og afgør, hvor $f$ er voksende og aftagende.
\end{enumerate}
...
\]
\begin{enumerate}[label=\arabic*)]
  \item Bestem $f'(x)$ og vis, at den kan skrives på formen $f'(x) = 6(x-2)(x+1)$.
  \item Løs ligningen $f'(x) = 0$.
  \item Opstil et fortegnsskema for $f'(x)$ og afgør, hvor $f$ er voksende og aftagende.
\end{enumerate}
...
\]
\begin{enumerate}[label=\arabic*)]
  \item Bestem $f'(x)$ og vis, at den kan skrives på formen $f'(x) = -3(x-3)(x+1)$.
  \item Løs ligningen $f'(x) = 0$.
  \item Opstil et fortegnsskema for $f'(x)$ og afgør, hvor $f$ er voksende og aftagende.
\end{enumerate}
...
\]
\begin{enumerate}[label=\arabic*)]
  \item Bestem $f'(x)$ og vis, at den kan skrives på formen $f'(x) = 4x(x-2)(x+2)$.
  \item Løs ligningen $f'(x) = 0$.
  \item Opstil et fortegnsskema for $f'(x)$ og afgør, hvor $f$ er voksende og aftagende.
  \item Hvad kan du sige om $f$'s lokale ekstrema?
\end{enumerate}
