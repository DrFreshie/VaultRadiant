...
\begin{enumerate}
  ...
  \item Løs ligningen $x^2 = 16$
  \item Løs ligningen $x^2 = 1$
  \item Løs ligningen $(x-2)^2 = 9$
  \item Løs ligningen $(x+1)^2 = 4$
  \item Løs ligningen $(x-5)^2 = 1$
  \item Løs ligningen $x^2 = 25$
  \item Løs ligningen $(x-3)^2 = 16$
  \item Løs ligningen $(x+4)^2 = 9$
  \item Løs ligningen $(x-1)^2 = 0$
\end{enumerate}

\subsection{}

\begin{enumerate}
  \item Løs ligningen $x^2 + 6x + 5 = 0$
  \item Løs ligningen $x^2 + 4x + 1 = 0$
  \item Løs ligningen $2x^2 + 5x + 2 = 0$
  \item Løs ligningen $x^2 + 2x - 3 = 0$
  \item Løs ligningen $3x^2 + 6x + 1 = 0$
  \item Løs ligningen $x^2 - 5x + 2 = 0$
  \item Løs ligningen $2x^2 - 3x - 5 = 0$
  \item Løs ligningen $-x^2 + 4x - 1 = 0$
  \item Løs ligningen $3x^2 - x - 4 = 0$
  \item Løs ligningen $-2x^2 + x + 3 = 0$
\end{enumerate}
