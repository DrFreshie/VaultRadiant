...
## %%Notes
- *08.05* Answer comprehension questions
- *08.40* Sum up 
- *08.50* Find your questions from last week and post them on the edaptio aflevering
- *09.00* Break 
- *09.10* Make groups of those who have made questions themselves, and ask them to go out and answer the analysis questions.
- *09.10* Those inside gets an introduction to to bloom's taxonomy - make questions visible on edaption so those outside can answer when they are done with the analysis-questions.
- *10.00* Break 
- *10.10* Continue
