...
\subsection*{Toppunktsformel for andengradspolynomiet $f(x)=ax^2+bx+c$}
\begin{align*}
\intertext{\hspace{1em} \circnum{1} Find den afledte af andengradspolynomiet:}
f'(x)&=2ax+b\\
\intertext{\hspace{1em} \circnum{2} Opskriv ligningen for maximum af en funktion:}
f'(x)&=0\\
2ax+b&=0\\
\intertext{\hspace{1em} \circnum{3} Isolér $x$ i ligningen:}
2ax&=-b\\
x&=\frac{-b}{2a}\\
\intertext{\hspace{1em} \circnum{4} Indsæt denne værdi for $x$ i $f$ og reducér:}
y=f\left(\frac{-b}{2a}\right)&=a\left(\frac{-b}{2a}\right)^2+b\cdot \left(\frac{-b}{2a}\right)+c\\
&=a\left(\frac{(-b)^2}{(2a)^2}\right)- \left(\frac{b^2}{2a}\right)+c\\
&=\frac{ab^2}{4a^2}-\frac{b^2}{2a}+c\\
&=\frac{b^2}{4a}-\frac{2\cdot b^2}{4a}+\frac{4a\cdot c}{4a}\\
&=\frac{-b^2+4ac}{4a}\\
&=\frac{-(b^2-4ac)}{4a}\\
&=\frac{-d}{4a}\\
\end{align*}
