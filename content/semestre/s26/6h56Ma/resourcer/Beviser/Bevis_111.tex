...
\subsection*{Differentialkvotient for $f(x)=\tfrac1x$}
\begin{align*}
\intertext{\hspace{1em} \circnum{1} Opskriv sekanthældningen:}
\frac{\Delta y}{\Delta x}=\frac{f(x+h)-f(x)}{h}&=\frac{\frac{1}{x+h}-\frac{1}{x}}{h}\\
\intertext{\hspace{1em} \circnum{2} Reducér udtrykket:}
&=\frac{\frac{x}{(x+h)\cdot x}-\frac{x+h}{x\cdot (x+h)}}{h}\\
&=\frac{\frac{-h}{(x+h)\cdot x}}{h}\\
&=\frac{-h}{(x+h)\cdot x\cdot h}\\
&=\frac{-1}{x^2+hx}\\
\intertext{\hspace{1em} \circnum{3} Lad $h\rightarrow 0$:}
f'(x)&=\lim_{h\rightarrow 0}\left(\frac{-1}{x^2+hx}\right)\\
&=\frac{-1}{x^2}
\end{align*}
