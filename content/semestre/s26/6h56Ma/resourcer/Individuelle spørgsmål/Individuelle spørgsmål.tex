...
\item Gør, for et andengradspolynomium $f(x)=ax^2+bx+c$, rede for formlen til udregning af polynomiets rødder:
$$x=\frac{-b\pm \sqrt{b^2-4ac}}{2a},$$
og forklar hvordan koefficienterne $a$, $b$, og $c$ kan bestemmes ved hjælp af polynomiel regression.
...
\item Gør, for et andengradspolynomium $f(x)=ax^2+bx+c$, rede for formlen til udregning af polynomiets toppunkt:
$$T=\left(\frac{-b}{2a},\frac{-d}{4a}\right),$$
og forklar hvordan koefficienterne $a$, $b$, og $c$ kan bestemmes ved hjælp af polynomiel regression.
\end{enumerate}
