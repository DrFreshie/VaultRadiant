\documentclass[10pt,a4paper,table]{article}
	...
	\fancypagestyle{plain}{%
		...
		\fancyhead[L]{}
		\fancyhead[C]{}
		\fancyhead[R]{\overp\color{frbgreenl}\normalsize \overp Mat C-B\\\huge\color{frbgreen}\vestb Differentialkvotient}
		\cfoot{\thepage}
	}
	\pagestyle{fancy}
	\fancyhf{}
...
\begin{enumerate}
    % 1-5: polynomier med mindst tre led
    \item $f(x) = 3x^5 - 2x^3 + 7x - 4$
    \item $f(x) = -x^6 + 4x^4 - 2x^2 + 9$
    \item $f(x) = 6x^7 - 3x^3 + 5x^2 - 1$
    \item $f(x) = 2x^8 - 5x^5 + x^2 + 11$
    \item $f(x) = -4x^9 + 2x^6 - 3x^3 + 7x$

    % 6-20: blandede med simple regler
    \item $f(x) = x^4 + \sqrt{x}$
    \item $f(x) = \tfrac{1}{x} + x^3$
    \item $f(x) = e^x + 2x^2$
    \item $f(x) = \ln(x) + x^5$
    \item $f(x) = x^7 + \tfrac{3}{x}$
    \item $f(x) = x^2 + e^{3x} + \ln(x)$
    \item $f(x) = -5x^3 + \sqrt{x} + e^x$
    \item $f(x) = x^6 - 7x + \tfrac{2}{x}$
    \item $f(x) = 4x^2 + \ln(x) + 10$
    \item $f(x) = e^x - x^4 + \tfrac{1}{x}$
    \item $f(x) = x^3 + x^2 + \sqrt{x}$
    \item $f(x) = -2x^5 + \ln(x) + 4^x$
    \item $f(x) = x^8 + 6x^2 - \tfrac{4}{x}$
    \item $f(x) = 3x^4 + e^x + \sqrt{x}$
    \item $f(x) = \ln(x) + x^3 - 9x$
\end{enumerate}
