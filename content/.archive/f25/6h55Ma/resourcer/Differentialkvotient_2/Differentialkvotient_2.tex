...
\begin{enumerate}
    ...
    \item Tegn en monotonilinje for funktionen.
    \item Bestem monotoniforholdene for funktionen.
    \item Bestem eventuelle $x$-værdier, hvor funktionen har ekstremum.
\end{enumerate}

\subsection{}
Funktionen $f$ er givet ved
\[
    f(x) = \ln(x) + 2x - x^2, \quad x > 0
\]
