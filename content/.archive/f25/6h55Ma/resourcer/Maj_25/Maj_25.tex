\documentclass[10pt,a4paper,table]{article}
	...
	\fancypagestyle{plain}{%
		...
		\fancyhead[C]{\overp\color{frbgreenl}\normalsize \overp Mat C-B\\\Large\color{frbgreen}\vestb Prøve facit}
		\cfoot{\thepage}
	}
	\pagestyle{fancy}
	\fancyhf{}
...
\begin{enumerate}
    \item $y=f'(x_0)(x-x_0)+f(x_0)=1.7x+0.29$
    \item $a\cdot c=-1\quad\Leftrightarrow c=\frac{-1}{1.7}=-0.588$
\end{enumerate}

\subsection{}
\begin{enumerate}
  \item $f(x)=8.4879+5.0295\cdot \sin(0.5723x+0.3367)$
  \item $\text{max}=A+D=5.0295+8.4879=13.5174$
\end{enumerate}

\subsection{}
\begin{enumerate}
  \item $c(6,3)$ og $r=5$.
  \item $\text{dist}(l,c)=\frac{|0.75\cdot 6+8-3|}{\sqrt{0.75^2+1}}=7.6$
\end{enumerate}

\subsection{}
\begin{enumerate}
  \item $f(30)=322.7$.
  \item $f'(30)=2.538$. Dvs. antallet af danskere med diabetes stiger med gennemsnitlig 2.538 tusinde om året i 2030.
\end{enumerate}

\subsection{}
\begin{enumerate}
  \item $E(X)=n\cdot p=206\cdot 0.117=24.102$.
  \item Acceptområdet er $[15;33]$, og da 13 ligger uden for dette acceptområde kan vi forkaste nulhypotesen.
\end{enumerate}

\clearpage
\subsection{}
\begin{enumerate}
  \item Grafen i intervallet $x=[-10;10]$:
...
\item $f'(x)=3\quad\Leftrightarrow x=-2\text{ eller }x=4.$ Grafen har, som det også kan ses på nedenstående figur, altså en hældning på 3 i $x=-2$ og $x=4$.
