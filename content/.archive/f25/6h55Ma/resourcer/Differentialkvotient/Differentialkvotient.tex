...
\subsection{}
Indsæt de angivne værdier i funktionerne, og reducer udtrykkene mest muligt.

\begin{enumerate}
    \item Lineær funktion: $f(x) = 2x+3$
    \begin{enumerate}
        \item Bestem $f(4)$
        \item Bestem $f(a)$
        \item Bestem $f(3+a)$
    ...
    \item Generelt andengradspolynomium: $f(x) = ax^2 + bx + c$
    \begin{enumerate}
        \item Bestem $f(2)$
        \item Bestem $f(c)$
        \item Bestem $f(1+c)$
    ...
    \item Kvadratrodsfunktion: $f(x) = \sqrt{x}$
    \begin{enumerate}
        \item Bestem $f(9)$
        \item Bestem $f(d)$
        \item Bestem $f(4+d)$
