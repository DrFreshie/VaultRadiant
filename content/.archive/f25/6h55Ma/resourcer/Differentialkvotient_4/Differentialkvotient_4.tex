...
\subsection{}
Givet funktionen $f(f)=x^3-2x+\sqrt{2x+12}$.
\begin{enumerate}
    \item Bestem $f(2)$.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item $f(x) = \sqrt{x} \cdot \cos(x)$
    \item $f(x) = e^x \cdot \sin(x)$
    \item $f(x) = x^3 \cdot e^{2x}$
    \item $f(x) = (x^2 + 1)\sin(x)$
    \item $f(x) = (3x - 2)\ln(x)$
    \item $f(x) = x^4 \cos(x)$
    \item $f(x) = (x^3 + 1)e^{-x}$
    \item $f(x) = (2x^2 - 5)\sqrt{x}$
\end{enumerate}
...
\
        \begin{itemize}
            ...
            \item Produktregel: $(f\cdot g)' = f'\cdot g + f\cdot g'$
            \item Kæderegel (lineær): $(f(ax+b))' = a\cdot f'(ax+b)$
        \end{itemize}
