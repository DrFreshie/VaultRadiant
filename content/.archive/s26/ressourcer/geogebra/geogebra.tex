...
\documentclass[10pt,a4paper,table]{article}
	...
	\fancypagestyle{plain}{%
		...
		\fancyhead[L]{}
		\fancyhead[C]{}
		\fancyhead[R]{\overp\color{frbgreenl}\normalsize \overp Mat C-B\\\huge\color{frbgreen}\vestb Geogebra-øvelser}
		\cfoot{\thepage}
	}
	\pagestyle{fancy}
	\fancyhf{}
...
\subsection{}
\begin{enumerate}
    \item Tegn grafen for funktionen $f(x)=x^2+6x+13$ så man kan se funktionsværdierne for $0<x<50$.
    \item Beregn funktionsværdien $f(30)$.
    \item Løs ligningen $f(x)=3000$.
\end{enumerate}

\subsection{}

\begin{enumerate}
  \item Tegn grafen for funktionen $f(x)=2x^2-4x+10$ så man kan se funktionsværdierne for $0<x<40$.
  \item Beregn funktionsværdien $f(20)$.
  \item Løs ligningen $f(x)=800$.
\end{enumerate}

\subsection{}

\begin{enumerate}
  \item Tegn grafen for funktionen $f(x)=5x+120$ så man kan se funktionsværdierne for $0<x<60$.
  \item Beregn funktionsværdien $f(45)$.
  \item Løs ligningen $f(x)=500$.
\end{enumerate}

\subsection{}

\begin{enumerate}
  \item Tegn grafen for funktionen $f(x)=3\cdot1.08^x$ så man kan se funktionsværdierne for $0<x<30$.
  \item Beregn funktionsværdien $f(10)$.
  \item Løs ligningen $f(x)=60$.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Bestem også tallene $a$ og $b$ ved eksonentiel regression.
\end{enumerate}
