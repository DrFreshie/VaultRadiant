\documentclass[10pt,a4paper]{article}
	...
	\usepackage{graphicx}
	\graphicspath{{./img/}{../../Compendium/assets/}}
...
\thispagestyle{empty}
\begin{center}
  \includegraphics[width=0.6\textwidth]{s-town-ch1.png}
\end{center}

\begin{center}
  \href{https://stownpodcast.org/chapter/1}{https://stownpodcast.org/chapter/1}
\end{center}
\end{document}
