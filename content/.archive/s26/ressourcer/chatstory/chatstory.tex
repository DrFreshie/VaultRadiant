...
\setcounter{page}{1}
\linenumbers
WHEN Miss Emily Grierson died, our whole town went to her funeral: the men through a sort of respectful \glos{affection}{hengivelse}{subs.} for a fallen monument, the women mostly out of curiosity to see the inside of her house, which no one save an old man-servant--a combined gardener and cook--had seen in at least ten years.
...
"I'm sure that won't be necessary," Judge Stevens said. "It's probably just a snake or a rat that n----- of hers killed in the yard. I'll speak to him about it."
...
\subsection{Glossary}
\glos{affection}{hengivenhed}{subs.}\\
\glos{encroached}{trængte ind på}{verb}\\
\glos{obliterated}{udslettede}{verb}\\
\glos{august}{fornem}{adj.}\\
\glos{coquettish}{koket}{adj.}\\
\glos{hereditary}{arvelig}{adj.}\\
\glos{edict}{dekret}{subs.}\\
\glos{dispensation}{fritagelse}{subs.}\\
\glos{perpetuity}{evighed}{subs.}\\
\glos{archaic}{gammeldags}{adj.}\\
\glos{deputation}{delegation}{subs.}\\
\glos{dank}{fugtig}{adj.}\\
\glos{tarnished}{anløben}{adj.}\\
\glos{errand}{ærinde}{subs.}\\
\glos{temerity}{dumdristighed}{subs.}\\
\glos{diffident}{tilbageholdende}{adj.}\\
\glos{deprecation}{undskyldende modvilje}{subs.}\\
\glos{slunk}{sneg sig}{verb}\\
\glos{tableau}{opstilling}{subs.}\\
\glos{spraddled}{bredbenet}{adj.}\\
\glos{vindicated}{retfærdiggjort}{verb}\\
\glos{condolence}{kondolence}{subs.}\\
\glos{serene}{afklaret}{adj.}\\
\glos{jalousies}{skodder}{subs.}\\
\glos{impervious}{upåvirkelig}{adj.}\\
\glos{haughty}{hovmodig}{adj.}\\
\glos{cabal}{sammensværgelse}{subs.}\\
\glos{circumvent}{omgå}{verb}\\
\glos{sibilant}{hvæsende}{adj.}\\
\glos{inextricable}{uløselig}{adj.}
\end{document}
