...
\begin{description}
\item[Theme:] Belonging
\item[Text:] Sandra Cisneros, "My Name" from \textit{The House on Mango Street} (1984) (short prose)
...
\item and make an analysis of the writer's use of language and imagery.
\end{itemize}
\end{description}
...
\includepdf[pages=1-]{Øvespørgsmål_4_tekst.pdf}
