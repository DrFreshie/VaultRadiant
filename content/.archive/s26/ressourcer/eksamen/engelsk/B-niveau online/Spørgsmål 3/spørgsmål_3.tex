...
\begin{description}
\item[Theme:] Coming to America
\item[Text:] Laurence Blair, \qm{Risking it all: migrants brave Darién Gap in pursuit of the American dream}. Article.

{[…] angiver forkortelser i forhold til originalen.}
\item[NS:] 3
\item[Instruction:] You must analyse and interpret \qm{Risking it all: migrants brave Darién Gap in pursuit of the American dream} and make a presentation (roughly 8 minutes) of the text and relate the text to the theme \qm{Coming to America}.
...
\includepdf[pages=1-]{./risking_it_all.pdf}
