...
\item[Text:] Isabel Huggan, \qm{Celia Behind Me}. Short story.  

{[…] angiver forkortelser i forhold til originalen.}
\item[NS:] 2,9
\item[Instruction:] You must analyse and interpret \qm{Celia Behind Me} by Isabel Huggan and make a presentation (roughly 8 minutes) of the text and relate the text to the theme \qm{Growing Up}.
...
\includepdf[pages=1-]{./celia_behind_me.pdf}
