...
\item[Text:] Theresa Ronan, \qm{The Road Home}. Short story.

{[…] angiver forkortelser i forhold til originalen.}
\item[NS:] 3
\item[Instruction:] You must analyse and interpret \qm{The Road Home} and make a presentation (roughly 8 minutes) of the text and relate the text to the theme \qm{Coming to America}.
...
\includepdf[pages=1-]{./the_road_home.pdf}
