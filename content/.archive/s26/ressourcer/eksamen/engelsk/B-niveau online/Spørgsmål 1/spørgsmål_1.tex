...
\begin{description}
\item[Theme:] Growing Up
\item[Text:] Kelly Oakes, \qm{Why children become bullies at school}. Article.

{[…] angiver forkortelser i forhold til originalen.}
\item[NS:] 3
\item[Instruction:] You must analyse and interpret \qm{Why children become bullies at school} and make a presentation (roughly 8 minutes) of the text and relate the text to the theme \qm{Growing Up}.
...
\includepdf[pages=1-]{./why_children_become_bullies.pdf}
