...
\item[Text:] Moria Lomas, \qm{One of the Good Ones}. Short story.

{[…] angiver forkortelser i forhold til originalen.}
\item[NS:] 2,6
\item[Instruction:] You must analyse and interpret \qm{One of the Good Ones} and make a presentation (roughly 8 minutes) of the text and relate the text to the theme \qm{New Zealand}.
...
\includepdf[pages=1-]{./one_of_the_good_ones.pdf}
