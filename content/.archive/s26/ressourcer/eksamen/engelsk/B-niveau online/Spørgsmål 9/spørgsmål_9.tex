...
\begin{description}
\item[Theme:] Class and Education in Britain
\item[Text:] Simon Hattenstone, \qm{Eat your gruel and be thankful for it: why the hero of \textit{I, Daniel Blake} is taking it to the stage}. Interview.

{[…] angiver forkortelser i forhold til originalen.}
\item[NS:] 3
\item[Instruction:] You must analyse and interpret \qm{Eat your gruel and be thankful for it: why the hero of \textit{I, Daniel Blake} is taking it to the stage} and make a presentation (roughly 8 minutes) of the text and relate it to the theme \qm{Class and Education in Britain}.
...
\includepdf[pages=1-]{./eat_your_gruel.pdf}
