...
\item[Text:] Guy Garcia, \qm{Some Like It Hot: Hispanics and the American Melting Pot}. Article.

{[…] angiver forkortelser i forhold til originalen.}
\item[NS:] 3
\item[Instruction:] You must analyse and interpret \qm{Some Like It Hot: Hispanics and the American Melting Pot} and make a presentation (roughly 8 minutes) of the text and relate the text to the theme \qm{Coming to America}.
...
\includepdf[pages=1-]{./some_like_it_hot.pdf}
