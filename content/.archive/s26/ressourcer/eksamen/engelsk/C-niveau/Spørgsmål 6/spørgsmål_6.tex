...
\item[Text:] Sophie Gonzales, \textit{Perfect on Paper} (2021) (novel extract)
...
\item and make a characterisation of the main character.
\end{itemize}
\end{description}
...
\includepdf[pages=1-]{Spørgsmål_6_tekst.pdf}
