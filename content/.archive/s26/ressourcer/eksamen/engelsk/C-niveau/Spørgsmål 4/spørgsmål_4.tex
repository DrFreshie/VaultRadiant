...
\begin{description}
\item[Theme:] Borders
\item[Text:] Soledad Castillo, "At 14, I walked through the desert to reach the US. My story didn't end there" (2019) (article) (abridged)
...
\item and make an analysis of the writers intention.
\end{itemize}.
\end{description}
...
\includepdf[pages=1-]{spørgsmål_4_tekst.pdf}
