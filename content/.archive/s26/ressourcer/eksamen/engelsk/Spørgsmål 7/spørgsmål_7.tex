...
\begin{description}
\item[Theme:] Voice
\item[Text:] Sherman Alexie, "Superman and Me" (1998) (essay) (abridged)
...
\item and make an analysis of the theme of the text.
\end{itemize}
\end{description}
...
\includepdf[pages=1-]{superman_and_me_tekst.pdf}
