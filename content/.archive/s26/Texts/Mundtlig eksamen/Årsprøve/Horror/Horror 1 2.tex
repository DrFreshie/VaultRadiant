...
\begin{description}
\item[Theme:] Horror
\item[Text:] Edgar Allen Poe, “The Black Cat” (1843) (short story) (abridged)
\item[Instruction:] You must analyse and interpret “The Black Cat” by Edgar Allen Poe and make a presentation (roughly 8 minutes) of the text and relate it to the theme. Apart from your own points, you must include the following points in your presentation:
\begin{itemize}
\item characterisation of the narrator
\item identification of suspense and horror
\end{itemize}
\end{description}
...
\item Der lægges i bedømmelsen vægt på, at eksaminanden kan indgå i uddybende samtale om præsentationen.
\end{itemize}
Der gives én karakter ud fra en helhedsvurdering af eksaminandens præstation.


\includepdf[pages=1-]{The Black Cat.pdf}
