...
\begin{description}
\item[Theme:] Horror
\item[Text:] Max Brooks, “World War Z” (2006) (novel) (excerpt)
\item[Instruction:] You must analyse and interpret the excerpt from “World War Z” by Max Brooks and make a presentation (roughly 8 minutes) of the text and relate it to the theme. Apart from your own points, you must include the following points in your presentation:
\begin{itemize}
\item characterisation of the interviewee
\item the style of writing used by Max Brooks
\end{itemize}
\end{description}
