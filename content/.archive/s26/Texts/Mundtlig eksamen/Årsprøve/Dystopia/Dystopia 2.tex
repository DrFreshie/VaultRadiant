...
\begin{description}
\item[Theme:] Dystopia
\item[Text:] Henry Slesar, “Examination Day” (1985) (short story)
\item[Instruction:] You must analyse and interpret “Examination Day” by Henry Slesar and make a presentation (roughly 8 minutes) of the text and relate it to the theme. Apart from your own points, you must include the following points in your presentation:
\begin{itemize}
\item the setting
\item the style of writing
\end{itemize}
\end{description}
...
\includepdf[pages=1-]{Examination Day.pdf}
